...
// import Img_Info1 from './Template_images/m10.avif'
...
//       <div className='img1'>
//   <Link to='/template/0'><img src={Img_Info1} alt='EV Mobile' /></Link>
//   <main>EV Mobile</main>
// </div>
// <div className='img2'>
//   <Link to='/template/1'><img src={Img_Info2} alt='Write Web' /></Link>
//   <main>Write Web</main>
// </div>
// <div className='img3'>
//   <Link to='/template/2'><img src={Img_Info3} alt='Techigen' /></Link>
//   <main>Techigen</main>
// </div>
// <div className='img4'>
//   <Link to='/template/3'><img src={Img_Info4} alt='ITravel' /></Link>
//   <main>ITravel</main>
// </div>
//       </div>
//       </div>
...
//     <Link to="/All_Template"><button className='btn-EC'>View All</button></Link></div>
//         <div className='Images'>
// <div className='img1'>
//   <Link to='/template/4'><img src={Img_EC1} alt='Couchly Store' /></Link>
//   <main>Cloth Store</main>
// </div>

// <div className='img2'>
//   <Link to='/template/5'><img src={Img_EC2} alt='Dreamy Delights' /></Link>
//   <main>Dreamy Delights</main>
// </div>

// <div className='img3'>
//   <Link to='/template/6'><img src={Img_EC3} alt='Book Store' /></Link>
//   <main>Book Store</main>
// </div>

// <div className='img4'>
//   <Link to='/template/7'><img src={Img_EC4} alt='Davito Electro' /></Link>
//   <main>Davito Electro</main>
// </div>
//         </div>
//       </div>
//     </div>
