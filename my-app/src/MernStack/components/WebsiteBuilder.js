...
// import Img9 from './Template_images/m8.jpeg';
// import Img10 from './Template_images/m9.jpg';
...
// import { Link } from 'react-router-dom'; // Make sure you're using react-router-dom for routing
// import { gsap } from 'gsap';
// import '../CSS-files/WebBuild.css'
// import { ScrollTrigger } from 'gsap/ScrollTrigger';
// import Img1 from './Template_images/m73.jpg';
// import Img2 from './Template_images/m58.webp';
// import Img3 from './Template_images/m11.jpg';
// import Img4 from './Template_images/m15.png';
// import Img5 from './Template_images/m23.webp';
// import Img6 from './Template_images/m1.jpeg';
// import Img7 from './Template_images/m6.webp';
// import Img8 from './Template_images/m7.jpg';
...
//   useEffect(() => {
//     // GSAP animation for page elements and images
...
//   return (
//     <div className='Website-Builder'>
//       <div className='web1' ref={el => addToRefs(el, sectionRefs)}>
//         <div className='P1'>
//           <img src={Img1} alt='Img1 is not working' ref={el => addToRefs(el, imageRefs)} />
//         </div>
//         <div className='P2'>
//           <h1>G&B Solutionz Website Builder</h1>
//           <h2>Create Your Website with ease</h2>
//           <p>G&B Solutionz Website Builder provides flexibility and the latest features to create a website as per your needs</p>
//           <Link to="/signUp"><button className='web1-p2'>Create a Website</button></Link>
//         </div>
//       </div>

//       <div className='web2' ref={el => addToRefs(el, sectionRefs)}>
//         <div className='P1'>
//           <h1>15 Days Free Trials</h1>
//           <p>Try our Builder For 15 Days without any payment information</p>
//         </div>
...
//       <div className='hdg1' ref={el => addToRefs(el, sectionRefs)}>
//         <h1>Website Builder Features</h1>
//         <h4>Following features at G&B Website Builder will enable you to create, design, manage, and develop</h4>
//         <h5>Websites with an unforgettable user experience.</h5>
//       </div>

//       {/* Features Sections with Animation */}
//       {[Img2, Img3, Img4, Img5, Img6].map((img, idx) => (
//         <div className={`web${idx + 3}`} ref={el => addToRefs(el, sectionRefs)} key={idx}>
//           <div className='P1'>
//             {idx % 2 === 0
//               ? <img src={img} alt={`Feature ${idx}`} ref={el => addToRefs(el, imageRefs)} />
//               : (
//                 <>
//                   <h1>{['SEO Tools', 'SSL CERTIFICATE', 'CUSTOM COLORS AND FONTS', 'CUSTOM DOMAINS', 'RESPONSIVE DESIGN'][idx]}</h1>
//                   <h2>{[
//                     'Drive Traffic to your Website Using SEO',
//                     'Protect Your Website Through SSL',
//                     'Give a Stylish Look to your Website',
//                     'Get a Custom Domain & Create Your Brand',
//                     'Mobile-friendly Websites'][idx]}
//                   </h2>
//                   <p>Brief description for feature {idx + 1}</p>
//                 </>
//               )}
//           </div>
//           <div className='P2'>
...
//       {/* Steps Section */}
//       <div className='web8' ref={el => addToRefs(el, sectionRefs)}>
//         <div className="P1">
//           <li>START BUILDING A WEBSITE</li>
...
//           <p>Choose it's a website or an online store. Name it and select a suitable category.</p>
//           <li>SELECT FONTS AND COLORS</li>
//           <p>Pick fonts and colors to match your style. You can change later anytime.</p>
...
//         </div>
//         <div className="P2">
//           <img src={Img6} alt='m2 image is not working' ref={el => addToRefs(el, imageRefs)} />
//         </div>
//       </div>

//       {/* Templates Section */}
//       <div className='web9' ref={el => addToRefs(el, sectionRefs)}>
//         <div className='P1'>
//           <h1>Website Templates with a Professional Look</h1>
//           <h2>90 Website Templates to meet your Business needs.</h2>
//         </div>
//         <div className='P2'>
//           <Link to="/template/0"><img src={Img2} alt='Image6 is not working' className='Img6' ref={el => addToRefs(el, imageRefs)} /></Link>
//           <Link to="/template/1"><img src={Img7} alt='Image7 is not working' className='Img7' ref={el => addToRefs(el, imageRefs)} /></Link>
//           <Link to="/template/2"><img src={Img8} alt='Image8 is not working' className='Img8' ref={el => addToRefs(el, imageRefs)} /></Link>
//         </div>
//         <Link to="/All_Template"><button className="btn-tamp">See All Templates</button></Link>
//       </div>

//       {/* FAQ Section */}
//       <div className='web10' ref={el => addToRefs(el, sectionRefs)}>
//         <div className='heading'>
//           <h1>Frequently Asked Questions</h1>
//           <p>FAQ regarding Creating a Website at G&B Website Builder</p>
//         </div>
